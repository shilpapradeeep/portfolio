        ...
        <section className="hero-section page-section scroll-to-page" id="home">
            ...
            <div className="custom-container">
                <div className="hero-content content-width">
                    ...
                    <p className="scroll-animation" data-animation="fade_from_bottom">Software developer with 6+ years of demonstrated experience in creating software solutions to enhance business productivity using Agile/Lean processes and enterprise management standards</p>
